import{o as p,a as c,d as e,u as o}from"./vue-libs.42034ed0.js";const b=function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))l(n);new MutationObserver(n=>{for(const h of n)if(h.type==="childList")for(const r of h.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&l(r)}).observe(document,{childList:!0,subtree:!0});function t(n){const h={};return n.integrity&&(h.integrity=n.integrity),n.referrerpolicy&&(h.referrerPolicy=n.referrerpolicy),n.crossorigin==="use-credentials"?h.credentials="include":n.crossorigin==="anonymous"?h.credentials="omit":h.credentials="same-origin",h}function l(n){if(n.ep)return;n.ep=!0;const h=t(n);fetch(n.href,h)}};b();var ha=(a,s)=>{const t=a.__vccOpts||a;for(const[l,n]of s)t[l]=n;return t};const _={class:"van-doc-markdown-body"},q=e("h1",null,"\u4ECB\u7ECD",-1),f=e("div",{class:"van-doc-card"},[e("h3",{id:"guan-yu",tabindex:"-1"},"\u5173\u4E8E"),e("p",null,"\u8FD9\u662F\u4E00\u6BB5\u7EC4\u4EF6\u5E93\u7684\u4ECB\u7ECD")],-1),y=e("div",{class:"van-doc-card"},[e("h3",{id:"te-xing",tabindex:"-1"},"\u7279\u6027"),e("ul",null,[e("li",null,"\u7279\u6027\u4E00"),e("li",null,"\u7279\u6027\u4E8C"),e("li",null,"\u7279\u6027\u4E09")])],-1),w=[q,f,y],k={setup(a,{expose:s}){return s({frontmatter:{}}),(l,n)=>(p(),c("div",_,w))}},x={class:"van-doc-markdown-body"},$=o(`<h1>\u5FEB\u901F\u4E0A\u624B</h1><div class="van-doc-card"><h3 id="an-zhuang" tabindex="-1">\u5B89\u88C5</h3><pre><code class="language-bash"><span class="hljs-comment"># \u901A\u8FC7 npm</span>
npm i TDesign
...
<span class="hljs-tag">&lt;/<span class="hljs-name">cell-gropu</span>&gt;</span>
  ...
  <span class="hljs-tag">&lt;<span class="hljs-name">cell</span> <span class="hljs-attr">title</span>=<span class="hljs-string">&quot;\u5355\u5143\u683C&quot;</span> <span class="hljs-attr">value</span>=<span class="hljs-string">&quot;\u5185\u5BB9&quot;</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">cell</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">cell-gropu</span>&gt;</span>
</code></pre></div><h2 id="api" tabindex="-1">API</h2><div class="van-doc-card"><h3 id="props" tabindex="-1">Props</h3><table><thead><tr><th>\u53C2\u6570</th><th>\u8BF4\u660E</th><th>\u7C7B\u578B</th><th>\u9ED8\u8BA4\u503C</th></tr></thead><tbody><tr><td>title</td><td>\u5355\u5143\u683C\u6807\u9898</td><td><em>string</em></td><td>-</td></tr><tr><td>value</td><td>\u5355\u5143\u683C\u53F3\u4FA7\u6587\u6848</td><td><em>string</em></td><td>-</td></tr><tr><td>icon</td><td>\u5DE6\u4FA7\u56FE\u6807\u540D\u79F0</td><td><em>string</em></td><td>-</td></tr><tr><td>placeholder</td><td>\u5360\u4F4D\u6587\u5B57</td><td><em>string</em></td><td>-</td></tr></tbody></table></div>`,10),O=[E],M={setup(a,{expose:s}){return s({frontmatter:{}}),(l,n)=>(p(),c("div",V,O))}},R={class:"van-doc-markdown-body"},G=e("h1",null,"collapse \u6298\u53E0\u9762\u677F",-1),N=[G],W={setup(a,{expose:s}){return s({frontmatter:{}}),(l,n)=>(p(),c("div",R,N))}},H={class:"van-doc-markdown-body"},U=o(`<h1>Dialog \u5BF9\u8BDD\u6846</h1><div class="van-doc-card"><h3 id="jie-shao" tabindex="-1">\u4ECB\u7ECD</h3><p>\u5F39\u51FA\u6A21\u6001\u6846\uFF0C\u5E38\u7528\u4E8E\u6D88\u606F\u63D0\u793A\u3001\u6D88\u606F\u786E\u8BA4\uFF0C\u6216\u5728\u5F53\u524D\u9875\u9762\u5185\u5B8C\u6210\u7279\u5B9A\u7684\u4EA4\u4E92\u64CD\u4F5C\u3002</p><p>\u652F\u6301\u51FD\u6570\u8C03\u7528\u548C\u7EC4\u4EF6\u8C03\u7528\u4E24\u79CD\u65B9\u5F0F\u3002</p></div><div class="van-doc-card"><h3 id="yin-ru" tabindex="-1">\u5F15\u5165</h3><pre><code class="language-js"><span class="hljs-keyword">import</span> <span class="hljs-title class_">Vue</span> <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>
...
</code></pre></div><h2 id="api" tabindex="-1">API</h2><div class="van-doc-card"><h3 id="props" tabindex="-1">Props</h3><table><thead><tr><th>\u53C2\u6570</th><th>\u8BF4\u660E</th><th>\u7C7B\u578B</th><th>\u9ED8\u8BA4\u503C</th></tr></thead><tbody><tr><td>name</td><td>\u56FE\u6807\u540D\u79F0</td><td><em>string</em></td><td>-</td></tr><tr><td>size <code>1.0.0</code></td><td>\u56FE\u6807\u5C3A\u5BF8</td><td><em>string</em></td><td><code>\u7EE7\u627F\u7236\u5143\u7D20</code></td></tr></tbody></table></div>`,7),Y=[Q],J={setup(a,{expose:s}){return s({frontmatter:{}}),(l,n)=>(p(),c("div",K,Y))}},X={class:"van-doc-markdown-body"},ss=o(`<h1>InfiniteScroll \u65E0\u9650\u6EDA\u52A8</h1><h2 id="dai-ma-yan-shi" tabindex="-1">\u4EE3\u7801\u6F14\u793A</h2><div class="van-doc-card"><h3 id="ji-chu-yong-fa" tabindex="-1">\u57FA\u7840\u7528\u6CD5</h3><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;list&quot;</span> <span class="hljs-attr">v-infinite-list</span>=<span class="hljs-string">&quot;load&quot;</span>&gt;</span>
...
</code></pre></div>`,3),as=[ss],ns={setup(a,{expose:s}){return s({frontmatter:{}}),(l,n)=>(p(),c("div",X,as))}},ts={class:"van-doc-markdown-body"},ls=e("h1",null,"List \u5217\u8868",-1),ps=[ls],cs={setup(a,{expose:s}){return s({frontmatter:{}}),(l,n)=>(p(),c("div",ts,ps))}},es={class:"van-doc-markdown-body"},os=e("h1",null,"Notify \u6D88\u606F\u901A\u77E5",-1),hs=[os],ds={setup(a,{expose:s}){return s({frontmatter:{}}),(l,n)=>(p(),c("div",es,hs))}},rs={class:"van-doc-markdown-body"},is=o(`<h1>Overlay \u906E\u7F69\u5C42</h1><div class="van-doc-card"><h3 id="jie-shao" tabindex="-1">\u4ECB\u7ECD</h3><p>\u521B\u5EFA\u4E00\u4E2A\u906E\u7F69\u5C42\uFF0C\u7528\u4E8E\u5F3A\u8C03\u7279\u5B9A\u7684\u9875\u9762\u5143\u7D20\uFF0C\u5E76\u963B\u6B62\u7528\u6237\u8FDB\u884C\u5176\u4ED6\u64CD\u4F5C\u3002</p></div><div class="van-doc-card"><h3 id="yin-ru" tabindex="-1">\u5F15\u5165</h3><pre><code class="language-js"><span class="hljs-keyword">import</span> { createApp } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>
...
</code></pre></div><h2 id="api" tabindex="-1">API</h2><div class="van-doc-card"><h3 id="props" tabindex="-1">Props</h3><table><thead><tr><th>\u53C2\u6570</th><th>\u8BF4\u660E</th><th>\u7C7B\u578B</th><th>\u9ED8\u8BA4\u503C</th></tr></thead><tbody><tr><td>width</td><td>\u753B\u5E03\u5BBD\u5EA6</td><td><em>string</em> <em>number</em></td><td><code>\u8BBE\u5907\u6700\u5927\u5BBD\u5EA6</code></td></tr><tr><td>height</td><td>\u753B\u5E03\u9AD8\u5EA6</td><td><em>string</em> <em>number</em></td><td><code>500</code></td></tr><tr><td>lineWidth</td><td>\u7EBF\u5BBD</td><td><em>string</em> <em>number</em></td><td><code>2</code></td></tr><tr><td>color</td><td>\u753B\u7EBF\u989C\u8272</td><td><em>string</em></td><td><code>black</code></td></tr><tr><td>filename</td><td>\u4FDD\u5B58\u7684\u6587\u4EF6\u540D</td><td><em>string</em></td><td><code>signature</code></td></tr><tr><td>fullscreen</td><td>\u662F\u5426\u5F00\u542F\u5168\u5C4F\u753B\u5E03</td><td><em>Boolean</em></td><td><code>false</code></td></tr><tr><td>imgType</td><td>\u4FDD\u5B58\u7684\u56FE\u7247\u683C\u5F0F</td><td><em>string</em></td><td><code>png</code>(\u53EF\u9009png\u3001jpeg\u3001webp)</td></tr></tbody></table></div>`,9),Vs=[Ls],Es={setup(a,{expose:s}){return s({frontmatter:{}}),(l,n)=>(p(),c("div",Bs,Vs))}},Os={class:"van-doc-markdown-body"},Ms=e("h1",null,"skeleton \u9AA8\u67B6\u5C4F",-1),Rs=[Ms],Gs={setup(a,{expose:s}){return s({frontmatter:{}}),(l,n)=>(p(),c("div",Os,Rs))}},Ns={class:"van-doc-markdown-body"},Ws=o(`<h1>Swipe \u8F6E\u64AD</h1><div class="van-doc-card"><h3 id="jie-shao" tabindex="-1">\u4ECB\u7ECD</h3><p>\u7528\u4E8E\u5FAA\u73AF\u64AD\u653E\u4E00\u7EC4\u56FE\u7247\u6216\u5185\u5BB9\u3002</p></div><div class="van-doc-card"><h3 id="yin-ru" tabindex="-1">\u5F15\u5165</h3><pre><code class="language-js"><span class="hljs-keyword">import</span> { createApp } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>
...
</code></pre></div><h2 id="api" tabindex="-1">API</h2><div class="van-doc-card"><h3 id="props" tabindex="-1">Props</h3><table><thead><tr><th>\u53C2\u6570</th><th>\u8BF4\u660E</th><th>\u7C7B\u578B</th><th>\u9ED8\u8BA4\u503C</th></tr></thead><tbody><tr><td>autoplay</td><td>\u81EA\u52A8\u8F6E\u64AD\u95F4\u9694\uFF0C\u5355\u4F4D\u4E3A ms</td><td><em>string</em> <em>number</em></td><td>-</td></tr><tr><td>duration</td><td>\u52A8\u753B\u65F6\u957F\uFF0C\u5355\u4F4D\u4E3A s</td><td><em>string</em> <em>number</em></td><td><code>500</code></td></tr><tr><td>loop</td><td>\u662F\u5426\u5F00\u542F\u5FAA\u73AF\u64AD\u653E</td><td><em>boolean</em></td><td><code>true</code></td></tr><tr><td>show-indicators</td><td>\u662F\u5426\u663E\u793A\u6307\u793A\u5668</td><td><em>boolean</em></td><td><code>true</code></td></tr></tbody></table></div>`,8),Hs=[Ws],Us={setup(a,{expose:s}){return s({frontmatter:{}}),(l,n)=>(p(),c("div",Ns,Hs))}},Fs={class:"van-doc-markdown-body"},Zs=o(`<h1>Tabs \u6807\u7B7E\u9875</h1><div class="van-doc-card"><h3 id="jie-shao" tabindex="-1">\u4ECB\u7ECD</h3><p>\u9009\u9879\u5361\u7EC4\u4EF6\uFF0C\u7528\u4E8E\u5728\u4E0D\u540C\u7684\u5185\u5BB9\u533A\u57DF\u4E4B\u95F4\u8FDB\u884C\u5207\u6362\u3002</p></div><div class="van-doc-card"><h3 id="yin-ru" tabindex="-1">\u5F15\u5165</h3><pre><code class="language-js"><span class="hljs-keyword">import</span> { createApp } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>
...
</code></pre></div><h2 id="api" tabindex="-1">API</h2><div class="van-doc-card"><h3 id="props" tabindex="-1">Props</h3><table><thead><tr><th>\u53C2\u6570</th><th>\u8BF4\u660E</th><th>\u7C7B\u578B</th><th>\u9ED8\u8BA4\u503C</th></tr></thead><tbody><tr><td>list</td><td>\u6570\u636E\u5217\u8868</td><td><em>Array</em></td><td>-</td></tr></tbody></table></div><div class="van-doc-card"><h3 id="slot" tabindex="-1">Slot</h3><table><thead><tr><th>\u540D\u79F0</th><th>\u8BF4\u660E</th></tr></thead><tbody><tr><td>default</td><td>\u7EC4\u4EF6\u5185\u90E8\u901A\u8FC7\u4F5C\u7528\u57DF\u63D2\u69FD\u5C06\u5217\u8868\u9879<code>item</code>\u548C\u7D22\u5F15<code>index</code>\u4F20\u9012\u7ED9\u7236\u7EC4\u4EF6</td></tr></tbody></table></div>`,9),ta=[na],la={setup(a,{expose:s}){return s({frontmatter:{}}),(l,n)=>(p(),c("div",aa,ta))}},j={name:"TDesign",build:{css:{preprocessor:"less"},site:{publicPath:"/static/site-dist"},configureVite(a){const{BUILD_TARGET:s}=process.env;return s==="site"&&(a.server.fs={strict:!1}),a}},site:{title:"TDesign",logo:"https://img.yzcdn.cn/vant/logo.png",nav:[{title:"\u5F00\u53D1\u6307\u5357",items:[{path:"home",title:"\u4ECB\u7ECD"},{path:"quickstart",title:"\u5FEB\u901F\u4E0A\u624B"}]},{title:"\u57FA\u7840\u7EC4\u4EF6",items:[{path:"button",title:"Button \u6309\u94AE"},{path:"cell",title:"Cell \u5355\u5143\u683C"},{path:"tabs",title:"Tabs \u6807\u7B7E\u9875"},{path:"toast",title:"Toast \u5F39\u7A97"},{path:"dialog",title:"Dialog \u5BF9\u8BDD\u6846"},{path:"popup",title:"Popup \u5F39\u51FA\u5C42"},{path:"overlay",title:"Overlay \u906E\u7F69\u5C42"},{path:"picker",title:"Picker \u9009\u62E9\u5668"},{path:"cascader",title:"Cascader \u7EA7\u8054\u9009\u62E9"},{path:"swipe",title:"Swipe \u8F6E\u64AD"},{path:"pull-refresh",title:"PullRefresh \u4E0B\u62C9\u5237\u65B0"},{path:"list",title:"List \u5217\u8868"},{path:"skeleton",title:"skeleton \u9AA8\u67B6\u5C4F"},{path:"notify",title:"Notify \u6D88\u606F\u901A\u77E5"},{path:"collapse",title:"Collapse \u6298\u53E0\u9762\u677F"},{path:"pagination",title:"Pagination  \u5206\u9875"}]},{title:"\u529F\u80FD\u6307\u4EE4",items:[{path:"infinite-list",title:"InfiniteScroll \u65E0\u9650\u6EDA\u52A8"}]},{title:"Beta",items:[{path:"signature",title:"Signature \u7535\u5B50\u7B7E\u540D"},{path:"virtual-list",title:"VirtualList \u865A\u62DF\u5217\u8868"},{path:"icon",title:"Icon \u56FE\u6807"}]}]}},da={Home:k,Quickstart:P,Button:S,Cascader:L,Cell:M,Collapse:W,Dialog:Z,Icon:J,InfiniteList:ns,List:cs,Notify:ds,Overlay:gs,Pagination:bs,Picker:ys,Popup:$s,PullRefresh:As,Rend:Ds,Signature:Es,Skeleton:Gs,Swipe:Us,Tabs:Qs,Toast:sa,VirtualList:la},ra="1.0.2",pa=navigator.userAgent.toLowerCase(),ia=/ios|iphone|ipod|ipad|android/.test(pa);function ja(a,s="-"){return a.replace(/([a-z\d])([A-Z])/g,"$1"+s+"$2").replace(/([A-Z])([A-Z][a-z\d]+)/g,"$1"+s+"$2").toLowerCase()}function ga(a){const s=document.createElement("textarea");s.value=a,s.setAttribute("readonly",""),s.style.position="absolute",s.style.left="-9999px",document.body.appendChild(s);const t=document.getSelection();if(!t)return;const l=t.rangeCount>0?t.getRangeAt(0):!1;s.select(),document.execCommand("copy"),document.body.removeChild(s),l&&(t.removeAllRanges(),t.addRange(l))}const g="zh-CN",ca="en-US",u="vant-cli-lang";let d=g;function ua(){return d}function ma(a){d=a,localStorage.setItem(u,a)}function va(a){const s=localStorage.getItem(u);if(s){d=s;return}if(navigator.language&&navigator.language.indexOf("zh-")!==-1){d=g;return}d=a||ca}let i=[],m=!1;function ea(a){m?a():i.push(a)}window.top===window?window.addEventListener("message",a=>{a.data.type==="iframeReady"&&(m=!0,i.forEach(s=>s()),i=[])}):window.top.postMessage({type:"iframeReady"},"*");function v(){var t,l;const a=window.vueRouter,{path:s}=a.currentRoute.value;return(t=j.site.simulator)!=null&&t.routeMapper?(l=j.site.simulator)==null?void 0:l.routeMapper(s):s}function ba(){window.top.postMessage({type:"replacePath",value:v()},"*")}function _a(){const a=document.querySelector("iframe");a&&ea(()=>{a.contentWindow.postMessage({type:"replacePath",value:v()},"*")})}function qa(a){window.addEventListener("message",s=>{var l,n;if(((l=s.data)==null?void 0:l.type)!=="replacePath")return;const t=((n=s.data)==null?void 0:n.value)||"";a.currentRoute.value.path!==t&&a.replace(t).catch(()=>{})})}export{ha as _,j as a,va as b,ga as c,da as d,_a as e,ja as f,ua as g,ba as h,ia as i,qa as l,ra as p,ma as s};
