...
</code></pre></div><h2 id="api" tabindex="-1">API</h2><div class="van-doc-card"><h3 id="props" tabindex="-1">Props</h3><table><thead><tr><th>\u53C2\u6570</th><th>\u8BF4\u660E</th><th>\u7C7B\u578B</th><th>\u9ED8\u8BA4\u503C</th></tr></thead><tbody><tr><td>autoplay</td><td>\u81EA\u52A8\u8F6E\u64AD\u95F4\u9694\uFF0C\u5355\u4F4D\u4E3A ms</td><td><em>string</em> <em>number</em></td><td>-</td></tr><tr><td>duration</td><td>\u52A8\u753B\u65F6\u957F\uFF0C\u5355\u4F4D\u4E3A s</td><td><em>string</em> <em>number</em></td><td><code>500</code></td></tr><tr><td>loop</td><td>\u662F\u5426\u5F00\u542F\u5FAA\u73AF\u64AD\u653E</td><td><em>boolean</em></td><td><code>true</code></td></tr><tr><td>show-indicators</td><td>\u662F\u5426\u663E\u793A\u6307\u793A\u5668</td><td><em>boolean</em></td><td><code>true</code></td></tr></tbody></table></div>`,7),os=[hs],ds={setup(a,{expose:s}){return s({frontmatter:{}}),(l,n)=>(p(),c("div",es,os))}},rs={class:"van-doc-markdown-body"},is=e(`<h1>Tabs \u6807\u7B7E\u9875</h1><div class="van-doc-card"><h3 id="jie-shao" tabindex="-1">\u4ECB\u7ECD</h3><p>\u9009\u9879\u5361\u7EC4\u4EF6\uFF0C\u7528\u4E8E\u5728\u4E0D\u540C\u7684\u5185\u5BB9\u533A\u57DF\u4E4B\u95F4\u8FDB\u884C\u5207\u6362\u3002</p></div><div class="van-doc-card"><h3 id="yin-ru" tabindex="-1">\u5F15\u5165</h3><pre><code class="language-js"><span class="hljs-keyword">import</span> { createApp } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>
...
&lt;/script&gt;
</code></pre></div><h2 id="api" tabindex="-1">API</h2><div class="van-doc-card"><h3 id="props" tabindex="-1">Props</h3><table><thead><tr><th>\u53C2\u6570</th><th>\u8BF4\u660E</th><th>\u7C7B\u578B</th><th>\u9ED8\u8BA4\u503C</th></tr></thead><tbody><tr><td>type</td><td>\u6309\u94AE\u7C7B\u578B</td><td><em>string</em></td><td><code>primary</code></td></tr><tr><td>color <code>1.0.0</code></td><td>\u6309\u94AE\u989C\u8272</td><td><em>string</em></td><td>-</td></tr></tbody></table></div><div class="van-doc-card"><h3 id="events" tabindex="-1">Events</h3><table><thead><tr><th>\u4E8B\u4EF6\u540D</th><th>\u8BF4\u660E</th><th>\u56DE\u8C03\u53C2\u6570</th></tr></thead><tbody><tr><td>click</td><td>\u70B9\u51FB\u65F6\u89E6\u53D1</td><td><em>event: MouseEvent</em></td></tr></tbody></table></div><div class="van-doc-card"><h3 id="slots" tabindex="-1">Slots</h3><table><thead><tr><th>\u540D\u79F0</th><th>\u8BF4\u660E</th></tr></thead><tbody><tr><td>default</td><td>\u9ED8\u8BA4\u63D2\u69FD</td></tr></tbody></table></div>`,11),vs=[ms],bs={setup(a,{expose:s}){return s({frontmatter:{}}),(l,n)=>(p(),c("div",us,vs))}},j={name:"TDesign",build:{css:{preprocessor:"less"},site:{publicPath:"/TDesign/site-dist"},configureVite(a){const{BUILD_TARGET:s}=process.env;return s==="site"&&(a.server.fs={strict:!1}),a}},site:{title:"TDesign",logo:"https://img.yzcdn.cn/vant/logo.png",nav:[{title:"\u5F00\u53D1\u6307\u5357",items:[{path:"home",title:"\u4ECB\u7ECD"},{path:"quickstart",title:"\u5FEB\u901F\u4E0A\u624B"}]},{title:"\u57FA\u7840\u7EC4\u4EF6",items:[{path:"button",title:"Button \u6309\u94AE"},{path:"cell",title:"cell \u5355\u5143\u683C"},{path:"tabs",title:"tabs \u6807\u7B7E\u9875"},{path:"icon",title:"icon \u56FE\u6807"},{path:"toast",title:"toast \u5F39\u7A97"},{path:"dialog",title:"dialog \u5BF9\u8BDD\u6846"},{path:"popup",title:"popup \u5F39\u51FA\u5C42"},{path:"overlay",title:"overlay \u906E\u7F69\u5C42"},{path:"picker",title:"picker \u9009\u62E9\u5668"},{path:"cascader",title:"cascader \u7EA7\u8054\u9009\u62E9"},{path:"swipe",title:"swipe \u8F6E\u64AD"}]}]}},ks={Home:k,Quickstart:P,Button:z,Cascader:E,Cell:M,Dialog:F,Icon:W,Overlay:J,Picker:ns,Popup:cs,Swipe:ds,Tabs:gs,Toast:bs},ws="1.0.2",qs=navigator.userAgent.toLowerCase(),Ts=/ios|iphone|ipod|ipad|android/.test(qs);function $s(a,s="-"){return a.replace(/([a-z\d])([A-Z])/g,"$1"+s+"$2").replace(/([A-Z])([A-Z][a-z\d]+)/g,"$1"+s+"$2").toLowerCase()}function Ps(a){const s=document.createElement("textarea");s.value=a,s.setAttribute("readonly",""),s.style.position="absolute",s.style.left="-9999px",document.body.appendChild(s);const t=document.getSelection();if(!t)return;const l=t.rangeCount>0?t.getRangeAt(0):!1;s.select(),document.execCommand("copy"),document.body.removeChild(s),l&&(t.removeAllRanges(),t.addRange(l))}const g="zh-CN",ys="en-US",u="vant-cli-lang";let d=g;function Cs(){return d}function As(a){d=a,localStorage.setItem(u,a)}function Is(a){const s=localStorage.getItem(u);if(s){d=s;return}if(navigator.language&&navigator.language.indexOf("zh-")!==-1){d=g;return}d=a||ys}let i=[],m=!1;function fs(a){m?a():i.push(a)}window.top===window?window.addEventListener("message",a=>{a.data.type==="iframeReady"&&(m=!0,i.forEach(s=>s()),i=[])}):window.top.postMessage({type:"iframeReady"},"*");function v(){var t,l;const a=window.vueRouter,{path:s}=a.currentRoute.value;return(t=j.site.simulator)!=null&&t.routeMapper?(l=j.site.simulator)==null?void 0:l.routeMapper(s):s}function zs(){window.top.postMessage({type:"replacePath",value:v()},"*")}function Ds(){const a=document.querySelector("iframe");a&&fs(()=>{a.contentWindow.postMessage({type:"replacePath",value:v()},"*")})}function Ss(a){window.addEventListener("message",s=>{var l,n;if(((l=s.data)==null?void 0:l.type)!=="replacePath")return;const t=((n=s.data)==null?void 0:n.value)||"";a.currentRoute.value.path!==t&&a.replace(t).catch(()=>{})})}export{xs as _,j as a,Is as b,Ps as c,ks as d,Ds as e,$s as f,Cs as g,zs as h,Ts as i,Ss as l,ws as p,As as s};
